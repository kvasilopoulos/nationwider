# Getting help with nationwider

Thanks for using nationwider. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/nationwider/issues) to make sure the 
