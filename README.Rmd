...
The goal of {nationwider} is to provide house price data from [<nationwide.co.uk>](nationwide.co.uk).
All datasets available have been curated using tidytools and are return in a
convenient rectangular tidy format.
